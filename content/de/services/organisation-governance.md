...
packages:
  - id: "ai-org-strategy"
    title: "KI-Organisationsstrategie"
    summary: "Struktur, Rollen und Betriebsmodell, mit denen KI von Einzelprojekten ins Tagesgeschäft kommt."
    why: |
    ...
    deliverables:
      ...
      - "Modell für Finanzierung, Priorisierung und Portfolio-Steuerung"
  ...
  - id: "ai-culture-advisory"
    ...
    value:
      ...
      - "Mitarbeitende, die KI als Unterstützung sehen, nicht als Bedrohung"
      - "Eine Organisation, die sich schneller an jede neue Fähigkeit anpasst"
    deliverables:
      - "Analyse von Adoption und Veränderungsbereitschaft"
      - "Führungsbotschaft und Kommunikationsplan"
      - "Rollenbasiertes Programm für KI-Kompetenz und Befähigung"
      - "Nutzungsrichtlinien und ein Champion-Netzwerk"
  ...
  - id: "eu-ai-act-conformity"
    ...
    value:
      ...
      - "Ein Governance-Setup, das sich an neue Leitlinien und Fristen anpasst"
    deliverables:
      - "Inventar und Risikoklassifizierung Ihrer KI-Systeme"
      - "Gap-Analyse gegenüber den geltenden Pflichten"
      - "Governance-Prozesse, Dokumentationsvorlagen und Aufsichtsrollen"
