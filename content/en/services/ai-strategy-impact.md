...
packages:
  - id: "process-assessment"
    ...
    summary: "A structured look at how work really flows through your organisation - and where data, decisions and hand-offs make AI worthwhile."
    why: |
    ...
    value:
      - "Invest where the process economics justify it, not where the hype is loudest"
      - "Spot data and ownership gaps before they derail projects"
      - "A shared, fact-based picture across business and IT"
      - "Re-prioritise quickly when markets or technology shift"
    deliverables:
      - "Process maps for the prioritised value streams"
      - "Pain points, data readiness and automation potential per step"
      - "A ranked shortlist of AI opportunities with rationale"

  - id: "ai-strategy"
    title: "AI strategy"
    summary: "A clear, prioritised plan for where AI fits your business model - and what it takes to get there."
    why: |
    ...
    value:
      - "One direction instead of scattered departmental experiments"
      - "Vendor-neutral choices that survive the next model generation"
      - "Clear sequencing: foundation first, then scale"
      - "A strategy leadership can explain, fund and measure"
    deliverables:
      - "Target picture and guiding principles for AI in your company"
      - "Prioritised initiative roadmap with dependencies and investment ranges"
      - "Build-vs-buy and platform recommendations"
      - "Executive briefing for decision-makers"

  - id: "ai-impact-advisory"
    title: "AI impact advisory"
    summary: "Putting a number on AI - business cases, success metrics and an honest view of what is and isn't worth it."
    why: |
    ...
    value:
      - "Funding decisions based on evidence, not enthusiasm"
      - "Early exits for ideas that won't pay off"
      - "Faster scaling of initiatives that prove their value"
      - "Transparency on running costs, not just build costs"
    deliverables:
      - "Business cases with baseline, target metrics and total cost of ownership"
      - "Measurement concept for pilots and production"
      - "Go / no-go recommendation per initiative"

  - id: "agentic-automation-strategy"
    title: "Agentic automation strategy"
    summary: "Deciding where AI agents can take over real workflows - and how to do it safely and at scale."
    why: |
    ...
    value:
      - "Automate variable, knowledge-heavy work that rules could never cover"
      - "Autonomy levels matched to risk, with people involved where it matters"
      - "Reusable building blocks instead of one-off prototypes"
      - "Ready to adopt new agent capabilities as they mature"
    deliverables:
      - "Agent opportunity map with an autonomy level per workflow"
      - "Guardrail and oversight concept"
      - "Target architecture and reusable components for an agent platform"
      - "Pilot plan for the first high-value workflows"
---
